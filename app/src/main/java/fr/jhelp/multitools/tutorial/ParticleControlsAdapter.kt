...
class ParticleControlsAdapter(vararg elements: Pair<Int, () -> Unit>) :
    RecyclerView.Adapter<ParticleControlsHolder>()
{
    private val elements = Array(elements.size) { index -> elements[index] }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ParticleControlsHolder
    {
        ...
        return ParticleControlsHolder(layout)
    }

    override fun getItemCount(): Int =
        this.elements.size

    override fun onBindViewHolder(holder: ParticleControlsHolder, position: Int)
    {
