...
private val MONTH_REGEX = interval('0', '9').regexIn().between(1, 2).group()
private val DAY_REGEX = interval('0', '9').regexIn().between(1, 2).group()
private val HOUR_REGEX = interval('0', '9').regexIn().between(1, 2).group()
private val MINUTE_REGEX = interval('0', '9').regexIn().between(1, 2).group()
private val SECOND_REGEX = interval('0', '9').regexIn().between(1, 2).group()
